...
For every arithmetic calculation, enclose the computation in <<>>.
...
Let's think step by step."""
    ...
    def evaluate_thought(self, question: str, thought: str, cache: bool = True) -> float:
        ...
        # 修改提示，要求检查输出是否严格遵守指定格式，并且计算是否正确：
...
- All arithmetic computations must be enclosed within <<>>.
- The final answer must be on a new line starting with '####'.
Also, verify that the calculations are correct based on the problem constraints.
Question: {question}
Thought: {thought}
